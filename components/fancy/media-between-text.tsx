...
>(
  (
    ...
    return (
      ...
      >
        <motion.div layout className={leftTextClassName}>
          {firstText}
        </motion.div>
        <motion.div
        ...
        >
          {mediaType === 'video' ? (
            ...
            <img
              ...
              alt={
                alt ||
                `${typeof firstText === 'string' ? firstText : 'First'} ${typeof secondText === 'string' ? secondText : 'Second'}`
              }
              className="w-full h-full object-cover"
            />
          )}
        </motion.div>
        <motion.div layout className={rightTextClassName}>
          {secondText}
        </motion.div>
      </div>
    );
